...
// The studio's catalogue, shared with every screen that chooses a package
// from it — and narrowing that goes through the kernel rather than being
        ...
        {/*
          ...
          */}
                <PackagePicker
                  ...
                  onValuesChange={setCatalogueValues}
                  onChoose={(id: string) => addPackage(id)}
                  onCreateBespoke={(name: string) => addPackage('custom', name)}
                  alreadyOn={(id: string) => lines.filter((l) => l.packageId === id).length}
